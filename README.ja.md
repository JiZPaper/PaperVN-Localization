...
- ソースからビルドする場合はXcode 26以降
- インターネット接続

## ソースからビルド

1. Xcode 26以降で`PaperVN.xcodeproj`を開きます。
2. `PaperVN`スキームを選択します。
3. iOS 26以降のシミュレータまたはデバイスを選び、アプリを実行します。
4. 実機で実行する場合は、Signing & Capabilitiesでご自身の開発チームを選択してください。必要に応じてBundle Identifierも変更します。
